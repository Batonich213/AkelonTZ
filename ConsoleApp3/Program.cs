...
namespace PracticTask1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var AviableWorkingDaysOfWeekWithoutWeekends = new List<DayOfWeek>() { DayOfWeek.Monday, DayOfWeek.Thursday, DayOfWeek.Thursday, DayOfWeek.Wednesday, DayOfWeek.Thursday, DayOfWeek.Friday };
